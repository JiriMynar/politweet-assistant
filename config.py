...
# Načtení OpenAI API klíče s ověřením
OPENAI_API_KEY = os.environ.get('OPENAI_API_KEY')
if not OPENAI_API_KEY:
    print("VAROVÁNÍ: Proměnná prostředí OPENAI_API_KEY není nastavena. Některé funkce aplikace nebudou fungovat správně.")
    OPENAI_API_KEY = ''  # Prázdný řetězec pro případ, že klíč není nastaven

# Konfigurace OpenAI
OPENAI_MODEL = os.environ.get('OPENAI_MODEL', 'gpt-4o')  # Použití modelu GPT-4o
